...
async function main() {
    ...
    for (const mod of modulos) {
        ...
        for (const cls of modClasses) {
            ...
            let vids = explicitMatches.map(m => m[1]);
    ...
    markdown += `\n**Total de videos insertados:** ${totalVideos}`;
    
    const outputPath = path.join(__dirname, '..', 'docs', 'Videos_Integrados.md');
